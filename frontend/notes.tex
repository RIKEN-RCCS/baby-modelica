...
all the features of an object-oriented language.  Flattening is
indispensable even for simple tools, because parameter values in a
model may be substituted multiple times by nested parameterization.  A
generated flat model is hopefully to be re-readable by Modelica
compilers.
