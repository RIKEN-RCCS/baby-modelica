...
\begin{QFACT} Global variables are visible everywhere.
$\mathit{time}$ and $\mathit{end}$ are the only global
variables.\end{QFACT}
%%%%
They are variables, and thus, not defined in the
unnamed-enclosing-class.
%%%%
\begin{quote}
...
\subsection{A predefined variable}
...
\end{quote}
%%%%
($\mathit{time}$ looks like being defined in the model's root).
