...
non-connector component is unusable.  Connectors in a disabled
component are disabled.  A conditional connector can be used only in
connect_equations.  Connect_equations with a disabled connector are
considered removed.
...
%%%%
Conditional components cannot be used in modifiers of declarations.
