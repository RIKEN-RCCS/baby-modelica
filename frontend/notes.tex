...
Flow variables are equal to zero.
...
A connector declaration may have a condition to enable/disable it.
Such a connector can be used only in connect_equations.
Connect_equations with a disabled connector are considered removed.
...
%%%%
\begin{specquote}{5.6.2} [Conditional components can be used in
...
a conditional component does not affect the scope.  Particularly, a
