...
declarations should be ignored for that.  An outside_connector can be
syntactically distinguished by a use of a non-composite name like $x$
in $\mathrm{connect}(x,...)$.\end{QFACT}
...
A connector may contain integers, reals, connectors, and records, but
not models.
