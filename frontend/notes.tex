...
The $\mathrm{cardinality}\,(c)$ operator returns the use count of
connect_equations on the inside part of the argument connector.  It is
not the size of a connection set.  Cardinality of an embedded
