...
the connector.  Note that determination of an outside_connector must
respect the place where the connector is declared, and inner/outer
declarations should be ignored for that.

\begin{QFACT} (?) An outside_connector can be syntactically
distinguished as a use of a non-composite name like $x$ in
$\mathrm{connect}(x,...)$.\end{QFACT}
