...
taken into account in connect_equations but (*?*) not in the
...
first part of a composite name is a declared connector).\end{QFACT}
%%%%
...
operator_records, and connectors (but not models especially).  A
...
A stream_connector is a connector cotaining stream_variables.  A
...
is a translation-time constant, but the connector reference is not
(array indices can be non-constants).
